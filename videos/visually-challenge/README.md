# Visually — WebMCP Challenge film

An 84-second, seven-scene HyperFrames composition built from original Visually product capture. It demonstrates typed WebMCP actions, human/agent continuity, client-side exports, FFmpeg/WASM, templates, responsive editing, and the Visually brand lockup.
...
See `BRIEF.md`, `STORYBOARD.md`, and `SCRIPT.md` for the creative brief, shot plan, and narration.
