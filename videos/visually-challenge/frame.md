...
colors:
  ...
  text-muted: "#4D35B5"
  text-light: "#9A9A9A"
  accent-light: "rgba(118, 87, 255, 0.08)"
  accent-medium: "rgba(118, 87, 255, 0.15)"
  border: "rgba(118, 87, 255, 0.2)"
  card-bg: "rgba(118, 87, 255, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
- **Fonts** — already set to **DM Sans** (display) / **Manrope** (body); ignore any preset font name lingering in prose.
